                    ...
                    <div data-aos="fade-left" data-aos-duration="2000" className="card shrink-0 w-full shadow-2xl bg-base-100 flex-1">
                        ...
                        <form className="card-body">
                            <div className="form-control">
                                ...
                                <input type="text" placeholder="Enter Your Name" className="input input-bordered rounded-full" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                            ...
                            <div className="form-control">
                                ...
                                <input type="file" placeholder="Enter Your Email" className="px-4 py-2.5 input input-bordered rounded-full mb-2" required />
                            </div>
